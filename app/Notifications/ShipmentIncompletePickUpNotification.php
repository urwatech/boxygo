...
class ShipmentIncompletePickUpNotification extends Notification implements ShouldQueue
{
    use Queueable;
    use LocalizedFcm;
    ...
    public function toFcm(object $notifiable): void
    {
        ...
        $body = $this->fcmTranslate($notifiable, $this->description);
