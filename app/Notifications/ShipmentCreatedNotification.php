...
class ShipmentCreatedNotification extends Notification implements ShouldQueue
{
    ...
    public function toFcm(object $notifiable): void
    {
        ...
        $title = $this->fcmTranslate($notifiable, 'fcmTitleShipmentCreated');
        $body = $this->fcmTranslate($notifiable, 'fcmBodyShipmentCreated', [
    ...
    {
        $title = 'dbTitleShipmentCreated';
        $content = 'dbBodyShipmentCreated';

        return [
            'title' => $title,
            'content' => $content,
            'notification_type' => 'shipment',
            'icon' => 'shipment_created',
            'shipment_id' => $this->shipmentId,
            'tracking_number' => $this->trackingNumber,
            'pickup_address' => $this->pickupAddress,
            'delivery_address' => $this->deliveryAddress,
